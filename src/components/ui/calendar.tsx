    ...
    <DayPicker
      ...
      classNames={{
        ...
        caption: cn(
          ...
          "py-1" // Changed from pt-1 for symmetrical vertical padding
        ),
        caption_label: cn(
          "text-sm font-medium",
        ...
        caption_dropdowns: cn(
          ...
          "mx-8" // Added margin to prevent overlap with nav buttons
        ),
        dropdown: cn( 
        ...
        nav_button_previous: cn(
          "absolute left-1",
          "top-1/2 -translate-y-1/2" // Added for precise vertical centering
        ),
        nav_button_next: cn(
          "absolute right-1",
          "top-1/2 -translate-y-1/2" // Added for precise vertical centering
