...
export const tools: Tool[] = [
  ...
  { name: "Colour Picker", path: "/colour-picker", icon: Palette, description: "Pick colours and get their codes in various formats." },
  ...
  { name: "Timezone Converter", path: "/timezone-converter", icon: Globe, description: "Compare a full day across timezones on one aligned timeline, worldtimebuddy-style." },
  { name: "World Clock", path: "/world-clock", icon: Clock, description: "An interactive globe world clock, spin the earth, flip to a Mercator map, and see live times and timezone regions." },
  ...
  { name: "Text Statistics", path: "/text-statistics", icon: ChartBar, description: "Analyse text for word count, character count, and more." },
