        ...
        <div className="min-h-screen p-4 lg:p-8">
          <div className="max-w-7xl mx-auto space-y-12 md:space-y-16">
            <div className="mb-20">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-5 gap-3 md:gap-4 lg:gap-6">
                {allTools.map((tool) => (
                  <Link key={tool.path} href={tool.path}>
                    <div className="minimal-card group cursor-pointer aspect-square h-full w-full flex flex-col">
